...
<footer class="site-footer v-wrap">

    <div class="container">

        <div class="h-v-element text-center">


            <div class="signature">
                <span class="signature__text">website by </span>
                <a href="http://www.brivestudio.com" target="_blank">
                    <svg class="signature__logo" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 759.7 304" style="enable-background:new 0 0 759.7 304;" xml:space="preserve">
                
                <path class="tm-t" d="M722.2,23.6V4h-7V0h18.7v4h-7v19.6H722.2z"/>
                <path class="tm-m" d="M736.9,23.6V0h7.1l4.3,16.1L752.5,0h7.1v23.6h-4.4V5l-4.7,18.6H746L741.3,5v18.6H736.9z"/>
